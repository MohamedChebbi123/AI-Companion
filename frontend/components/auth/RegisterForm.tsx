...
export function RegisterForm() {
  ...
  const [form, setForm] = useState({ email: '', password: '', display_name: '', locale: 'en', status: 'active' });
  ...
  const field = (key: keyof typeof form) => (e: ChangeEvent<HTMLInputElement>) =>
      ...
      <div className="rounded-2xl backdrop-blur-sm overflow-hidden" style={t.card}>
        ...
        <div className="px-7 pt-6 pb-2">
          ...
          <p className="mt-1 text-[14px]" style={{ color: t.muted }}>
            Join Aura and start your AI experience
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-7 pt-5 pb-7 flex flex-col gap-3.5">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="display_name" className="text-[12.5px] font-medium tracking-[0.005em]" style={{ color: t.label }}>
              Display name
            </label>
            <input
              id="display_name"
        ...
        <div className="px-7 py-4 text-center" style={{ borderTop: t.divider }}>
          <p className="text-[13px]" style={{ color: t.footer }}>
            ...
            <a href="/login" className="transition-opacity hover:opacity-70" style={{ color: t.footerLink }}>
              Sign in
            </a>
          </p>
        </div>
